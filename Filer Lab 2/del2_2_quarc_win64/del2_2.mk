...
MODEL                = del2_2
MODULES              = del2_2_data.c del2_2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = del2_2.mk
...
MODELLIB                  = del2_2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = del2_2_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\del2_2_quarc_win64
