/*
 * Del1_RIKTIG_presentasjon_data.c
 *
...
P_Del1_RIKTIG_presentasjon_T Del1_RIKTIG_presentasjon_P = {
  ...
  -1.0,                                /* Variable: Joystick_gain_y
                                        ...
                                        */
  7.7807339449541244,                  /* Variable: K_pd
                                        * Referenced by: '<S5>/derivative gain'
                                        */
  15.561467889908249,                  /* Variable: K_pp
