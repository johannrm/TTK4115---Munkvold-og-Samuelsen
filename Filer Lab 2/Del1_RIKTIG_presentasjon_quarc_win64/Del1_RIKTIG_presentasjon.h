...
#ifndef RTW_HEADER_Del1_RIKTIG_presentasjon_h_
#define RTW_HEADER_Del1_RIKTIG_presentasjon_h_
#include <stddef.h>
#include <string.h>
#ifndef Del1_RIKTIG_presentasjon_COMMON_INCLUDES_
# define Del1_RIKTIG_presentasjon_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* Del1_RIKTIG_presentasjon_COMMON_INCLUDES_ */

#include "Del1_RIKTIG_presentasjon_types.h"
...
#define Del1_RIKTIG_presentasjon_rtModel RT_MODEL_Del1_RIKTIG_presenta_T
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S3>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<S6>/Integrator' */
} XDot_Del1_RIKTIG_presentasjon_T;
...
} XDis_Del1_RIKTIG_presentasjon_T;
...
#define rtB                            Del1_RIKTIG_presentasjon_B
#define BlockIO                        B_Del1_RIKTIG_presentasjon_T
#define rtX                            Del1_RIKTIG_presentasjon_X
#define ContinuousStates               X_Del1_RIKTIG_presentasjon_T
#define rtXdot                         Del1_RIKTIG_presentasjon_XDot
#define StateDerivatives               XDot_Del1_RIKTIG_presentasjon_T
#define tXdis                          Del1_RIKTIG_presentasjon_XDis
#define StateDisabled                  XDis_Del1_RIKTIG_presentasjon_T
#define rtP                            Del1_RIKTIG_presentasjon_P
#define Parameters                     P_Del1_RIKTIG_presentasjon_T
#define rtDWork                        Del1_RIKTIG_presentasjon_DW
#define D_Work                         DW_Del1_RIKTIG_presentasjon_T

/* Parameters (auto storage) */
struct P_Del1_RIKTIG_presentasjon_T_ {
...
struct tag_RTM_Del1_RIKTIG_presentas_T {
  const char_T *path;
...
extern P_Del1_RIKTIG_presentasjon_T Del1_RIKTIG_presentasjon_P;

/* Block signals (auto storage) */
extern B_Del1_RIKTIG_presentasjon_T Del1_RIKTIG_presentasjon_B;

/* Continuous states (auto storage) */
extern X_Del1_RIKTIG_presentasjon_T Del1_RIKTIG_presentasjon_X;

/* Block states (auto storage) */
extern DW_Del1_RIKTIG_presentasjon_T Del1_RIKTIG_presentasjon_DW;
...
extern void Del1_RIKTIG_presentasjon_initialize(void);
extern void Del1_RIKTIG_presentasjon_output0(void);
extern void Del1_RIKTIG_presentasjon_update0(void);
extern void Del1_RIKTIG_presentasjon_output(int_T tid);
extern void Del1_RIKTIG_presentasjon_update(int_T tid);
extern void Del1_RIKTIG_presentasjon_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Del1_RIKTIG_presentasjon_rtModel *Del1_RIKTIG_presentasjon(void);
...
extern RT_MODEL_Del1_RIKTIG_presenta_T *const Del1_RIKTIG_presentasjon_M;
 ...
 *
 * '<Root>' : 'Del1_RIKTIG_presentasjon'
 * '<S1>'   : 'Del1_RIKTIG_presentasjon/Conversion'
 * '<S2>'   : 'Del1_RIKTIG_presentasjon/Elevation controller'
 * '<S3>'   : 'Del1_RIKTIG_presentasjon/Heli 3D'
 * '<S4>'   : 'Del1_RIKTIG_presentasjon/Joystick'
 * '<S5>'   : 'Del1_RIKTIG_presentasjon/Pitch controller'
 * '<S6>'   : 'Del1_RIKTIG_presentasjon/Elevation controller/Elevation controller'
 */
#endif                                 /* RTW_HEADER_Del1_RIKTIG_presentasjon_h_ */
