...
P_del2_lQR_integral_T del2_lQR_integral_P = {
  ...
  0.0,                                 /* Expression: 0
                                        ...
                                        */
  -4.4721359549995769,                 /* Expression: -K(1,5)
                                        * Referenced by: '<S2>/Gain1'
                                        */
  17.553210132522906,                  /* Expression: K(1,3)
                                        * Referenced by: '<S2>/Gain'
                                        */
  0.0,                                 /* Expression: 0
                                        * Referenced by: '<S5>/Integrator'
                                        */
  4.4721359549995636,                  /* Expression: K(2,4)
                                        * Referenced by: '<S5>/Gain'
                                        */
  13.253813416725489,                  /* Expression: K(2,1)
                                        * Referenced by: '<S5>/proportional gain'
                                        */
  8.4594443065607,                     /* Expression: K(2,2)
