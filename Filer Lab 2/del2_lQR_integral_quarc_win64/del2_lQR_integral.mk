...
MODEL                = del2_lQR_integral
MODULES              = del2_lQR_integral_data.c del2_lQR_integral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = del2_lQR_integral.mk
...
MODELLIB                  = del2_lQR_integrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = del2_lQR_integral_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\del2_lQR_integral_quarc_win64
