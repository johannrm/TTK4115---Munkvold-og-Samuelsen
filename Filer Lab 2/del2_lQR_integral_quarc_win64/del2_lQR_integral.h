...
#ifndef RTW_HEADER_del2_lQR_integral_h_
#define RTW_HEADER_del2_lQR_integral_h_
#include <stddef.h>
#include <string.h>
#ifndef del2_lQR_integral_COMMON_INCLUDES_
# define del2_lQR_integral_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* del2_lQR_integral_COMMON_INCLUDES_ */

#include "del2_lQR_integral_types.h"
...
#define del2_lQR_integral_rtModel      RT_MODEL_del2_lQR_integral_T
...
typedef struct {
  ...
  struct {
    void *LoggedData[3];
  } elevationrateandreference_PWORK;   /* '<Root>/elevation rate and reference' */
  ...
  struct {
    void *LoggedData[2];
  } elevationandreference_PWORK;       /* '<S2>/elevation and reference ' */
  ...
  struct {
    void *LoggedData[2];
  } pitchandpitchreference_PWORK;      /* '<S5>/pitch and pitch reference' */
...
#define rtB                            del2_lQR_integral_B
#define BlockIO                        B_del2_lQR_integral_T
#define rtX                            del2_lQR_integral_X
#define ContinuousStates               X_del2_lQR_integral_T
#define rtXdot                         del2_lQR_integral_XDot
#define StateDerivatives               XDot_del2_lQR_integral_T
#define tXdis                          del2_lQR_integral_XDis
#define StateDisabled                  XDis_del2_lQR_integral_T
#define rtP                            del2_lQR_integral_P
#define Parameters                     P_del2_lQR_integral_T
#define rtDWork                        del2_lQR_integral_DW
#define D_Work                         DW_del2_lQR_integral_T

/* Parameters (auto storage) */
struct P_del2_lQR_integral_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain;                   /* Expression: -K(1,5)
                                        * Referenced by: '<S2>/Gain1'
                                        */
  real_T Gain_Gain;                    /* Expression: K(1,3)
                                        * Referenced by: '<S2>/Gain'
                                        */
  real_T Integrator_IC_o;              /* Expression: 0
                                        * Referenced by: '<S5>/Integrator'
                                        */
  real_T Gain_Gain_g;                  /* Expression: K(2,4)
                                        * Referenced by: '<S5>/Gain'
                                        */
  real_T proportionalgain_Gain;        /* Expression: K(2,1)
                                        * Referenced by: '<S5>/proportional gain'
                                        */
  real_T derivativegain_Gain;          /* Expression: K(2,2)
...
struct tag_RTM_del2_lQR_integral_T {
  const char_T *path;
...
extern P_del2_lQR_integral_T del2_lQR_integral_P;

/* Block signals (auto storage) */
extern B_del2_lQR_integral_T del2_lQR_integral_B;

/* Continuous states (auto storage) */
extern X_del2_lQR_integral_T del2_lQR_integral_X;

/* Block states (auto storage) */
extern DW_del2_lQR_integral_T del2_lQR_integral_DW;
...
extern void del2_lQR_integral_initialize(void);
extern void del2_lQR_integral_output0(void);
extern void del2_lQR_integral_update0(void);
extern void del2_lQR_integral_output(int_T tid);
extern void del2_lQR_integral_update(int_T tid);
extern void del2_lQR_integral_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern del2_lQR_integral_rtModel *del2_lQR_integral(void);
...
extern RT_MODEL_del2_lQR_integral_T *const del2_lQR_integral_M;
 ...
 *
 * '<Root>' : 'del2_lQR_integral'
 * '<S1>'   : 'del2_lQR_integral/Conversion'
 * '<S2>'   : 'del2_lQR_integral/Elevation controller'
 * '<S3>'   : 'del2_lQR_integral/Heli 3D'
 * '<S4>'   : 'del2_lQR_integral/Joystick'
 * '<S5>'   : 'del2_lQR_integral/Pitch controller'
 */
#endif                                 /* RTW_HEADER_del2_lQR_integral_h_ */
